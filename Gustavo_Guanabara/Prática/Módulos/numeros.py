from Gustavo_Guanabara.Prática.Módulos.uteis.numeros import fatorial_de_um_número, dobro, triplo # Como se pode observar, importei uma bliblioteca do meu próprio arquivo "numeros". Vale-se ressaltar que o uso do "from uteis import numeros" pode-se ser útil e ágil, poupando tempo do código.
número = int(input("Digite um número: ").strip())
fatorial = fatorial_de_um_número(número)
